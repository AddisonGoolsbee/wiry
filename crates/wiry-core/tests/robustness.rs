...
/// segments must cost about four times the work. The threshold sits between
/// linear and the sixteen a quadratic term would show, with enough room for a
/// shared machine's noise; above it the check would not catch what it is for.
#[test]
