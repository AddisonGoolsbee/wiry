# blitzpkt — project context and decisions
...
4. **Benchmark only on shared ground.** blitzpkt implements fewer protocols than
...
`blitzpkt` is **provisional**. It was verified free on PyPI, crates.io and GitHub
